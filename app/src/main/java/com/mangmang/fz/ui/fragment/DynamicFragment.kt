 ...
 */
class DynamicFragment : HasPFragment<DynamicP>(), DynamicContract.V, BaseQuickAdapter.OnItemChildClickListener {
    override fun onItemChildClick(adapter: BaseQuickAdapter<*, *>, view: View, position: Int) {
        when (view.id) {
            R.id.avatar -> Router.newIntent(activity).to(UserDetailActivity::class.java).launch()
        }
    }
